...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.mobilephones);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.mobilephones);
        }
        ...
        //</div>
        //<p class="msonormal">&nbsp;<a href="/android_asset/HTML/LEC01/mobilephones.htm">&gt;&gt;&gt; В НАЧАЛО  &gt;&gt;&gt;</a></p>
        //</body>
        //</html>
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
         if (id == R.id.mobilephones) {
            webView.loadUrl(resourceDir + "MOBILEPHONES/mobilephones.htm");
        } else if (id == R.id.smartphones) {
            webView.loadUrl(resourceDir + "SMARTPHONES/smartphones.htm");
        } else if (id == R.id.buymobilephones) {
            webView.loadUrl(resourceDir + "BUYMOBILE/buymobile.htm");
         } else if (id == R.id.buysmartphones) {
             webView.loadUrl(resourceDir + "BUYSMART/buysmart.htm");

            // Блок внешних переходов
        } else {
            if (id == R.id.nav_view1) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.technodom));
            }
            if (id == R.id.nav_view2) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.sulpak));
            }
            if (id == R.id.nav_view3) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.whitewind));
            }
